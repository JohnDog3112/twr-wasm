...
int register_local_mouse_move_event(int event_id, const char* element_id, int relative);
...
int register_local_mouse_down_event(int event_id, const char* element_id, int relative);
...
int register_local_mouse_up_event(int event_id, const char* element_id, int relative);
...
int register_local_mouse_click_event(int event_id, const char* element_id, int relative);
...
int register_local_mouse_double_click_event(int event_id, const char* element_id, int relative);
